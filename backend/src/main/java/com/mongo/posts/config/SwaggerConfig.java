...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.mongo.posts.resources"))
	...
	private ApiInfo apiInfo() {
		 return new ApiInfo(
		 "API do Projeto usando MongoDB",
		 "Esta API é um CRUD de posts e comentários dos seus usuários",
		 "Versão 1.0",
